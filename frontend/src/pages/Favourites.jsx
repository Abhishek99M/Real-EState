...
const Favourites = () => {
  ...
  return (
    <main className="!my-24 bg-gradient-to-r via-white from-lime-100 to-white">
      <div
        className="max-padd-container !py-10"
      >
        <div>
          ...
          <div className="grid gap-6 grid-cols-1 md:grid-cols-2 xl:grid-cols-3 !mt-10">
            ...
            favourites.includes(property.id)).filter((property) =>
