    ...
    <div className='!mt-12 flexCenter flex-col'>
      {
        !imageURL ? (
            ...
            <div onClick={() => widgetRef.current?.open()} className='w-3/4 h-[21rem] rounded-xl overflow-hidden cursor-pointer'>
                <img src={imageURL} alt='uploadImg' className='h-full w-full object-cover'/>
            </div>
        )}
